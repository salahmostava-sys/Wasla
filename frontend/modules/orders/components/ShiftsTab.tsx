...
export function ShiftsTab({
  ...
  const handlePrint = () => {
    ...
    style.textContent = '*{box-sizing:border-box;margin:0;padding:0}body{font-family:"Droid Arabic Kufi","Tajawal",Arial,sans-serif;font-size:10px;direction:rtl;color:#061735}h2{text-align:center;margin:8px 0}table{width:100%;border-collapse:collapse}th{background:#1f54ad;color:#fff;padding:4px;text-align:center;font-size:9px}td{padding:3px;border:1px solid #ddd;text-align:center}@media print{body{print-color-adjust:exact}}';
